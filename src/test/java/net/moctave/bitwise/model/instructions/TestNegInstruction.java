...
public class TestNegInstruction {
	private NegInstruction instructionLowerBound;
	private NegInstruction instructionMiddle;
	private NegInstruction instructionUpperBound;
	
	@BeforeEach
	public void init() {
		instructionLowerBound = new NegInstruction(0x1);
		instructionMiddle = new NegInstruction(0x8);
		instructionUpperBound = new NegInstruction(0xF);
	}
	...
	public void testAsBytesLowerBound() {
		...
		assertEquals((byte) 0x31, bytes.get(0));
	...
	public void testToStringLowerBound() {
		assertEquals("neg r1", instructionLowerBound.toString());
	}

	@Test
	public void testToStringMiddle() {
		assertEquals("neg r8", instructionMiddle.toString());
	}

	@Test
	public void testToStringUpperBound() {
		assertEquals("neg rF", instructionUpperBound.toString());
	}
