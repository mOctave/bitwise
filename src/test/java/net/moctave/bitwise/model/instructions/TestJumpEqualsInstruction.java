...
public class TestJumpEqualsInstruction {
	private JumpEqualsInstruction instruction;
	private JumpEqualsInstruction instructionTwo;
	private JumpEqualsInstruction instructionThree;
	private Map<String, Integer> labels;
	
	@BeforeEach
	public void init() {
		instruction = new JumpEqualsInstruction("Label 1");
		instructionTwo = new JumpEqualsInstruction("Label 2");
		instructionThree = new JumpEqualsInstruction("Label 3");
		labels = new HashMap<>();
	...
	public void testConstructor() {
		...
		assertEquals(0x1, instruction.getFnCode());
		...
		assertEquals(0x1, instructionTwo.getFnCode());
		...
		assertEquals(0x1, instructionThree.getFnCode());
	...
	public void testAsBytesNotUpdated() {
		...
		assertEquals((byte) 0x41, bytes.get(0));
	...
	public void testToString() {
		assertEquals("je Label 1", instruction.toString());
		assertEquals("je Label 3", instructionThree.toString());
	}
