...
public class TestJumpAlwaysInstruction {
	private JumpAlwaysInstruction instruction;
	private JumpAlwaysInstruction instructionTwo;
	private JumpAlwaysInstruction instructionThree;
	private Map<String, Integer> labels;
	
	@BeforeEach
	public void init() {
		instruction = new JumpAlwaysInstruction("Label 1");
		instructionTwo = new JumpAlwaysInstruction("Label 2");
		instructionThree = new JumpAlwaysInstruction("Label 3");
		labels = new HashMap<>();
	...
	public void testConstructor() {
		...
		assertEquals(0x0, instructionTwo.getFnCode());
		...
		assertEquals(0x0, instructionThree.getFnCode());
	...
	public void testAsBytesNotUpdated() {
		...
		assertEquals((byte) 0x40, bytes.get(0));
	...
	public void testToString() {
		assertEquals("jump Label 1", instruction.toString());
		assertEquals("jump Label 3", instructionThree.toString());
	}
