...
public class TestXorInstruction {
	private XorInstruction instructionLowerBound;
	private XorInstruction instructionMiddle;
	private XorInstruction instructionUpperBound;
	
	@BeforeEach
	public void init() {
		instructionLowerBound = new XorInstruction(0x1, 0xF);
		instructionMiddle = new XorInstruction(0x8, 0x7);
		instructionUpperBound = new XorInstruction(0xF, 0x1);
	}

	@Test
	public void testConstructorLowerBound() {
		assertEquals(0x2, instructionLowerBound.getOpCode());
		assertEquals(0x5, instructionLowerBound.getFnCode());
	...
	public void testConstructorMiddle() {
		assertEquals(0x2, instructionLowerBound.getOpCode());
		assertEquals(0x5, instructionMiddle.getFnCode());
	...
	public void testConstructorUpperBound() {
		...
		assertEquals(0x5, instructionUpperBound.getFnCode());
	...
	public void testAsBytesLowerBound() {
		...
		assertEquals((byte) 0x25, bytes.get(0));
	...
	public void testToStringLowerBound() {
		assertEquals("xor r1 rF", instructionLowerBound.toString());
	}

	@Test
	public void testToStringMiddle() {
		assertEquals("xor r8 r7", instructionMiddle.toString());
	}

	@Test
	public void testToStringUpperBound() {
		assertEquals("xor rF r1", instructionUpperBound.toString());
	}
