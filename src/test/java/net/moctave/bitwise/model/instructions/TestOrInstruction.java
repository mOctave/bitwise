...
public class TestOrInstruction {
	private OrInstruction instructionLowerBound;
	private OrInstruction instructionMiddle;
	private OrInstruction instructionUpperBound;
	
	@BeforeEach
	public void init() {
		instructionLowerBound = new OrInstruction(0x1, 0xF);
		instructionMiddle = new OrInstruction(0x8, 0x7);
		instructionUpperBound = new OrInstruction(0xF, 0x1);
	}

	@Test
	public void testConstructorLowerBound() {
		assertEquals(0x2, instructionLowerBound.getOpCode());
		assertEquals(0x4, instructionLowerBound.getFnCode());
	...
	public void testConstructorMiddle() {
		assertEquals(0x2, instructionLowerBound.getOpCode());
		assertEquals(0x4, instructionMiddle.getFnCode());
	...
	public void testConstructorUpperBound() {
		...
		assertEquals(0x4, instructionUpperBound.getFnCode());
	...
	public void testAsBytesLowerBound() {
		...
		assertEquals((byte) 0x24, bytes.get(0));
	...
	public void testToStringLowerBound() {
		assertEquals("or r1 rF", instructionLowerBound.toString());
	}

	@Test
	public void testToStringMiddle() {
		assertEquals("or r8 r7", instructionMiddle.toString());
	}

	@Test
	public void testToStringUpperBound() {
		assertEquals("or rF r1", instructionUpperBound.toString());
	}
