...
public class TestJumpNotEqualsInstruction {
	private JumpNotEqualsInstruction instruction;
	private JumpNotEqualsInstruction instructionTwo;
	private JumpNotEqualsInstruction instructionThree;
	private Map<String, Integer> labels;
	
	@BeforeEach
	public void init() {
		instruction = new JumpNotEqualsInstruction("Label 1");
		instructionTwo = new JumpNotEqualsInstruction("Label 2");
		instructionThree = new JumpNotEqualsInstruction("Label 3");
		labels = new HashMap<>();
	...
	public void testConstructor() {
		...
		assertEquals(0x4, instruction.getFnCode());
		...
		assertEquals(0x4, instructionTwo.getFnCode());
		...
		assertEquals(0x4, instructionThree.getFnCode());
	...
	public void testAsBytesNotUpdated() {
		...
		assertEquals((byte) 0x44, bytes.get(0));
	...
	public void testToString() {
		assertEquals("jne Label 1", instruction.toString());
		assertEquals("jne Label 3", instructionThree.toString());
	}
