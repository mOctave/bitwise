...
public class TestCopyInstruction {
	private CopyInstruction instructionLowerBound;
	private CopyInstruction instructionMiddle;
	private CopyInstruction instructionUpperBound;
	
	@BeforeEach
	public void init() {
		instructionLowerBound = new CopyInstruction(0x1, 0xF);
		instructionMiddle = new CopyInstruction(0x8, 0x7);
		instructionUpperBound = new CopyInstruction(0xF, 0x1);
	}
	...
	public void testAsBytesLowerBound() {
		...
		assertEquals((byte) 0x20, bytes.get(0));
	...
	public void testToStringLowerBound() {
		assertEquals("copy r1 rF", instructionLowerBound.toString());
	}

	@Test
	public void testToStringMiddle() {
		assertEquals("copy r8 r7", instructionMiddle.toString());
	}

	@Test
	public void testToStringUpperBound() {
		assertEquals("copy rF r1", instructionUpperBound.toString());
	}
