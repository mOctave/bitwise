...
public class TestAndInstruction {
	private AndInstruction instructionLowerBound;
	private AndInstruction instructionMiddle;
	private AndInstruction instructionUpperBound;
	
	@BeforeEach
	public void init() {
		instructionLowerBound = new AndInstruction(0x1, 0xF);
		instructionMiddle = new AndInstruction(0x8, 0x7);
		instructionUpperBound = new AndInstruction(0xF, 0x1);
	}

	@Test
	public void testConstructorLowerBound() {
		assertEquals(0x2, instructionLowerBound.getOpCode());
		assertEquals(0x3, instructionLowerBound.getFnCode());
	...
	public void testConstructorMiddle() {
		assertEquals(0x2, instructionLowerBound.getOpCode());
		assertEquals(0x3, instructionMiddle.getFnCode());
	...
	public void testConstructorUpperBound() {
		...
		assertEquals(0x3, instructionUpperBound.getFnCode());
	...
	public void testAsBytesLowerBound() {
		...
		assertEquals((byte) 0x23, bytes.get(0));
	...
	public void testToStringLowerBound() {
		assertEquals("and r1 rF", instructionLowerBound.toString());
	}

	@Test
	public void testToStringMiddle() {
		assertEquals("and r8 r7", instructionMiddle.toString());
	}

	@Test
	public void testToStringUpperBound() {
		assertEquals("and rF r1", instructionUpperBound.toString());
	}
