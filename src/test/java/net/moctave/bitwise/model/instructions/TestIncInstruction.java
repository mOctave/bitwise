...
public class TestIncInstruction {
	private IncInstruction instructionLowerBound;
	private IncInstruction instructionMiddle;
	private IncInstruction instructionUpperBound;
	
	@BeforeEach
	public void init() {
		instructionLowerBound = new IncInstruction(0x1);
		instructionMiddle = new IncInstruction(0x8);
		instructionUpperBound = new IncInstruction(0xF);
	}
	...
	public void testAsBytesLowerBound() {
		...
		assertEquals((byte) 0x30, bytes.get(0));
	...
	public void testToStringLowerBound() {
		assertEquals("inc r1", instructionLowerBound.toString());
	}

	@Test
	public void testToStringMiddle() {
		assertEquals("inc r8", instructionMiddle.toString());
	}

	@Test
	public void testToStringUpperBound() {
		assertEquals("inc rF", instructionUpperBound.toString());
	}
