...
public class TestJumpGreaterEqualsInstruction {
	private JumpGreaterEqualsInstruction instruction;
	private JumpGreaterEqualsInstruction instructionTwo;
	private JumpGreaterEqualsInstruction instructionThree;
	private Map<String, Integer> labels;
	
	@BeforeEach
	public void init() {
		instruction = new JumpGreaterEqualsInstruction("Label 1");
		instructionTwo = new JumpGreaterEqualsInstruction("Label 2");
		instructionThree = new JumpGreaterEqualsInstruction("Label 3");
		labels = new HashMap<>();
	...
	public void testConstructor() {
		...
		assertEquals(0x3, instruction.getFnCode());
		...
		assertEquals(0x3, instructionTwo.getFnCode());
		...
		assertEquals(0x3, instructionThree.getFnCode());
	...
	public void testAsBytesNotUpdated() {
		...
		assertEquals((byte) 0x43, bytes.get(0));
	...
	public void testToString() {
		assertEquals("jge Label 1", instruction.toString());
		assertEquals("jge Label 3", instructionThree.toString());
	}
