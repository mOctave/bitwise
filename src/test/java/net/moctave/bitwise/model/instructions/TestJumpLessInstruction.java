...
public class TestJumpLessInstruction {
	private JumpLessInstruction instruction;
	private JumpLessInstruction instructionTwo;
	private JumpLessInstruction instructionThree;
	private Map<String, Integer> labels;
	
	@BeforeEach
	public void init() {
		instruction = new JumpLessInstruction("Label 1");
		instructionTwo = new JumpLessInstruction("Label 2");
		instructionThree = new JumpLessInstruction("Label 3");
		labels = new HashMap<>();
	...
	public void testConstructor() {
		...
		assertEquals(0x5, instruction.getFnCode());
		...
		assertEquals(0x5, instructionTwo.getFnCode());
		...
		assertEquals(0x5, instructionThree.getFnCode());
	...
	public void testAsBytesNotUpdated() {
		...
		assertEquals((byte) 0x45, bytes.get(0));
	...
	public void testToString() {
		assertEquals("jl Label 1", instruction.toString());
		assertEquals("jl Label 3", instructionThree.toString());
	}
