...
public class TestJumpGreaterInstruction {
	private JumpGreaterInstruction instruction;
	private JumpGreaterInstruction instructionTwo;
	private JumpGreaterInstruction instructionThree;
	private Map<String, Integer> labels;
	
	@BeforeEach
	public void init() {
		instruction = new JumpGreaterInstruction("Label 1");
		instructionTwo = new JumpGreaterInstruction("Label 2");
		instructionThree = new JumpGreaterInstruction("Label 3");
		labels = new HashMap<>();
	...
	public void testConstructor() {
		...
		assertEquals(0x6, instruction.getFnCode());
		...
		assertEquals(0x6, instructionTwo.getFnCode());
		...
		assertEquals(0x6, instructionThree.getFnCode());
	...
	public void testAsBytesNotUpdated() {
		...
		assertEquals((byte) 0x46, bytes.get(0));
	...
	public void testToString() {
		assertEquals("jg Label 1", instruction.toString());
		assertEquals("jg Label 3", instructionThree.toString());
	}
